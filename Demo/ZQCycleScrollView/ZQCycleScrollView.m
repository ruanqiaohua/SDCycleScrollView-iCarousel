...
#define kZQCycleScrollViewInitialPageControlDotSize CGSizeMake(10, 10)

NSString * const ZQID = @"cycleCell";

@interface ZQCycleScrollView () <iCarouselDataSource,iCarouselDelegate>
...
@implementation ZQCycleScrollView
...
- (void)initialization
{
    _pageControlAliment = ZQCycleScrollViewPageContolAlimentCenter;
    ...
    _pageControlDotSize = kZQCycleScrollViewInitialPageControlDotSize;
    _pageControlStyle = ZQCycleScrollViewPageContolStyleClassic;
...
{
    ZQCycleScrollView *cycleScrollView = [[self alloc] initWithFrame:frame];
...
+ (instancetype)cycleScrollViewWithFrame:(CGRect)frame delegate:(id<ZQCycleScrollViewDelegate>)delegate placeholderImage:(UIImage *)placeholderImage
{
    ZQCycleScrollView *cycleScrollView = [[self alloc] initWithFrame:frame];
...
- (void)setPageControlDotSize:(CGSize)pageControlDotSize
{
    ...
    if ([self.pageControl isKindOfClass:[ZQPageControl class]]) {
        ZQPageControl *pageContol = (ZQPageControl *)_pageControl;
...
- (void)setCurrentPageDotColor:(UIColor *)currentPageDotColor
{
    ...
    if ([self.pageControl isKindOfClass:[ZQPageControl class]]) {
        ZQPageControl *pageControl = (ZQPageControl *)_pageControl;
...
- (void)setCurrentPageDotImage:(UIImage *)currentPageDotImage
{
    ...
    if (self.pageControlStyle != ZQCycleScrollViewPageContolStyleAnimated) {
        self.pageControlStyle = ZQCycleScrollViewPageContolStyleAnimated;
    }
...
- (void)setPageControlStyle:(ZQCycleScrollViewPageContolStyle)pageControlStyle
{
...
- (void)setupPageControl
{
    ...
    switch (self.pageControlStyle) {
        case ZQCycleScrollViewPageContolStyleAnimated:
        {
            ZQPageControl *pageControl = [[ZQPageControl alloc] init];
        ...
        case ZQCycleScrollViewPageContolStyleClassic:
        {
...
- (void)layoutSubviews
{
    ...
    if ([self.pageControl isKindOfClass:[ZQPageControl class]]) {
        ZQPageControl *pageControl = (ZQPageControl *)_pageControl;
        if (!(self.pageDotImage && self.currentPageDotImage && CGSizeEqualToSize(kZQCycleScrollViewInitialPageControlDotSize, self.pageControlDotSize))) {
    ...
    if (self.pageControlAliment == ZQCycleScrollViewPageContolAlimentRight) {
...
{
    ZQCollectionViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:ZQID forIndexPath:indexPath];
