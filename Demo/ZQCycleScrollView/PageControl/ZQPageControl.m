...
#import "ZQAbstractDotView.h"
#import "ZQAnimatedDotView.h"
#import "ZQDotView.h"
...
- (void)initialization
{
    self.dotViewClass           = [ZQAnimatedDotView class];
...
- (UIView *)generateDotView
{
    ...
    if (self.dotViewClass) {
        ...
        if ([dotView isKindOfClass:[ZQAnimatedDotView class]] && self.dotColor) {
            ((ZQAnimatedDotView *)dotView).dotColor = self.dotColor;
        }
    } else {
...
{
    if (self.dotViewClass) {
        ZQAbstractDotView *abstractDotView = (ZQAbstractDotView *)[self.dots objectAtIndex:index];
        if ([abstractDotView respondsToSelector:@selector(changeActivityState:)]) {
            [abstractDotView changeActivityState:active];
        } else {
            NSLog(@"Custom view : %@ must implement an 'changeActivityState' method or you can subclass %@ to help you.", self.dotViewClass, [ZQAbstractDotView class]);
        }
